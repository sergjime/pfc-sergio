...
INSERT INTO `usuarios` (`id_usuario`, `nombre`, `nick`, `password_login`, `apellido1`, `apellido2`, `rol_usuario`, `fecha_alta`, `email`) VALUES
(1, 'Sergio',  'sergjime', 'admin', 'Jiménez', 'Sastre', 'admin', '2019-03-29', 'sergjime@gmail.com'),
(2, 'Pedro', 'fighter', 'guay', 'Sánchez', 'Martínez', 'user', '2019-03-29', 'fighter@gmail.com'),
(3, 'Pablo', 'pablete', 'pablito', 'Alves', 'García', 'user', '2019-03-29', 'pablete@gmail.com'),
(4, 'David', 'kratos34', 'kratos', 'Kratos', 'Duro', 'user', '2019-03-29', 'kratos34@gmail.com'),
(5, 'Mario', 'luigi', 'luigi', 'Godoy', 'Salamanca', 'user', '2019-03-29', 'luigi@gmail.com');
